...
export interface ApiFundFund extends Schema.CollectionType {
  ...
  attributes: {
    investmentObjective: Attribute.Text;
    benchmark: Attribute.Text;
    ...
    fundInfo: Attribute.Component<'fund-components.fund-info'>;
    banner: Attribute.Text;
    attachment: Attribute.Component<'fund-components.files', true>;
    navpu: Attribute.Component<'fund-components.navpu'>;
